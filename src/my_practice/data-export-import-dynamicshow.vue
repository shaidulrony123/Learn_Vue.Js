...
<template>
      <section flex>
        ...
        <section class="content">
            <section class="person"><img :title="people[0].name" :src="people[0].image" :alt="people[0].image">
                <div>
                    <h1>{{ people[0].name }}</h1>
            ...
            <section class="person"><img :title="people[1].name" :src="people[1].image" :alt="people[1].image">
                <div>
                    <h1>{{ people[1].name }}</h1>
            ...
            <section  class="person"><img :title="people[2].name" :src="people[2].image" :alt="people[2].image">
                <div>
                    <h1>{{ people[2].name }}</h1>
